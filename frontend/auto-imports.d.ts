...
declare global {
  ...
  const UPLOAD_HISORY_LIMIT: typeof import('../common/app-env').UPLOAD_HISORY_LIMIT
  ...
  const useBucketStore: typeof import('./stores/bucket').useBucketStore
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly UPLOAD_HISORY_LIMIT: UnwrapRef<typeof import('../common/app-env')['UPLOAD_HISORY_LIMIT']>
    ...
    readonly useBucketStore: UnwrapRef<typeof import('./stores/bucket')['useBucketStore']>
    ...
    readonly useNavigationStore: UnwrapRef<typeof import('./stores/navigation')['useNavigationStore']>
